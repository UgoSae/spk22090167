...
class PreferensiController extends Controller
{
    public function preferensi()
    {
        ...
        // Hitung jarak Euclidean dan nilai preferensi untuk setiap dosen
        foreach ($weightedNormalizations as $id => $weightedNormalization) {
            ...
            $preferences[] = [
                ...
                'nilai_preferensi' => $distanceNegative / ($distanceNegative + $distancePositive),
            ];
        }
        ...
        return view('topsis.preferensi', compact('preferences'));
    }
}
